...
<ul>
    ...
    <li><p>SprintBoot (2.5.9)</p></li>
    <li><p>Sprint-Security-OAuth (2.3.8.RELEASE)</p></li>
...
<h3>如何上手</h3>
<ol>
    <li>clone或下载项目工程到本地</li>
    <li>查看 <a href="others/How-To-Use.txt">How-To-Use.txt</a> 文件(位于 <em>others</em>目录中)内容按步骤操作即可</li>
</ol>
...
<ol>
    ...
    <li><p>2020-09-20  从v1.1.2版本开始团队移到Gitee上进行开发维护, Github上不再更新</p></li>
    <li><p>2022-01-27  v1.1.2版本中升级Spring Boot到v2.5.9, spring-security-oauth2到2.3.8.RELEASE; 处理CVE相关漏洞</p></li>
    <li><p>2022-08-02  团队加入新成员 <a href="https://gitee.com/changly_admin">changly</a></p></li>
</ol>
...
<ul>
    ...
    <li><p><a href="https://andaily.com/blog/?p=20077">spring-security-oauth2从v2.4.0.RELEASE开始不推荐使用并迁移</a> </p></li>
</ul>
